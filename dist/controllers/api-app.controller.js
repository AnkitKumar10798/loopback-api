...
], ApiAppController.prototype, "create", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], ApiAppController.prototype, "count", null);
tslib_1.__decorate([
    rest_1.get('/users', {
        responses: {
            '200': {
    ...
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", Promise)
], ApiAppController.prototype, "find", null);
tslib_1.__decorate([
    rest_1.patch('/users', {
        responses: {
            '200': {
    ...
    tslib_1.__metadata("design:returntype", Promise)
], ApiAppController.prototype, "updateAll", null);
tslib_1.__decorate([
    rest_1.get('/users/{id}', {
        responses: {
            '200': {
    ...
    tslib_1.__metadata("design:returntype", Promise)
], ApiAppController.prototype, "findById", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], ApiAppController.prototype, "updateById", null);
tslib_1.__decorate([
    rest_1.put('/users/{id}', {
        responses: {
            '204': {
    ...
    tslib_1.__metadata("design:paramtypes", [Number, models_1.User]),
    tslib_1.__metadata("design:returntype", Promise)
], ApiAppController.prototype, "replaceById", null);
tslib_1.__decorate([
    rest_1.del('/users/{id}', {
        responses: {
            '204': {
    ...
    tslib_1.__metadata("design:returntype", Promise)
], ApiAppController.prototype, "deleteById", null);
ApiAppController = tslib_1.__decorate([
    tslib_1.__param(0, repository_1.repository(repositories_1.UserRepository)),
    tslib_1.__metadata("design:paramtypes", [repositories_1.UserRepository])
], ApiAppController);
exports.ApiAppController = ApiAppController;
//# sourceMappingURL=api-app.controller.js.map